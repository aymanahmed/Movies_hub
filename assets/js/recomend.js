...
function httpGetAsync(callback , file)
	...
	$('#searchForm').submit( function(event){
		...
		$('#choice').css({'margin' : '-150 15% 0 0', 'float': 'right'})
		$('#field').css({'margin' : '80px 0px 0px 50px' , 'float' : 'right'})
...
httpGetAsync(main , "assets/json/titles.json");
httpGetAsync(setData , "assets/json/test.json");